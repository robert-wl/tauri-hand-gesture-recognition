...
const ARGS_MAP = {"model":"{\"remove\":[\"model_name\"],\"train\":[\"dataset_name\",\"model_name\",\"hyperparameter\"],\"predict\":[\"model_name\",\"image\"],\"get_all\":[],\"get\":[\"model_name\"]}","dataset":"{\"preprocess\":[\"dataset_name\"],\"get_data\":[\"dataset_name\",\"label_name\"],\"get_random_image\":[\"path\"],\"get\":[\"dataset_name\"],\"get_all_training_dataset\":[],\"get_labels\":[\"dataset_name\"],\"get_processed_image\":[\"name\",\"label\",\"data\"],\"get_processed_graphs\":[\"name\"],\"get_random_processed_image\":[\"path\"],\"get_all\":[],\"get_image\":[\"name\",\"label\",\"data\"],\"get_all_testing_dataset\":[]}","util":"{\"get_current_dir\":[],\"open_directory\":[]}"}
