...
const ARGS_MAP = {"model":"{\"get\":[\"model_name\"],\"train\":[\"dataset_name\",\"model_name\",\"hyperparameter\"],\"remove\":[\"model_name\"],\"get_all\":[],\"predict\":[\"model_name\",\"image\"]}","dataset":"{\"get_all_training_dataset\":[],\"get_all_testing_dataset\":[],\"get_random_processed_image\":[\"path\"],\"get_data\":[\"dataset_name\",\"label_name\"],\"get\":[\"dataset_name\"],\"get_image\":[\"name\",\"label\",\"data\"],\"get_processed_image\":[\"name\",\"label\",\"data\"],\"get_processed_graphs\":[\"name\"],\"preprocess\":[\"dataset_name\"],\"get_labels\":[\"dataset_name\"],\"get_random_image\":[\"path\"],\"get_all\":[]}","util":"{\"get_current_dir\":[],\"open_directory\":[]}"}
